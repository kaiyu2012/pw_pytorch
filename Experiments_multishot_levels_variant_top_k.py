...
def main():
    EXPERIMENT_NAME = 'cora_multishot_top_k(1-5)_adj'
    NUMBER_OF_RUNS = 3
    ...
    for k in top_k_list:
      ...
      for runs in range(NUMBER_OF_RUNS):
        ...
        for pruner in prune_strategy:
          ...
          experiment_results['k_'+str(k)]['run_'+str(runs)][pruner].append(top_val_acc)
          
    print('\n--- The results of top-[1, 2, 3, 4, 5] validation accuracy: ----') 
